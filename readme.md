![Preview](https://raw.githubusercontent.com/jmiguelrivas/tambora/refs/heads/master/fastlane/metadata/android/en-US/images/featureGraphic.png)

# Tambora

**Tambora** is a **minimal, privacy-first Android launcher** designed for focus, speed, and
simplicity.

Built entirely in **native Kotlin**, Tambora runs fully **on-device**, avoids tracking, and keeps
distractions to a minimum by emphasizing clarity and intentional interaction.

<p align="center">
<a href="https://github.com/jmiguelrivas/tambora/releases"><img alt="GitHub releases" src="https://img.shields.io/github/release/jmiguelrivas/tambora.svg"></a>
...
<a href="https://github.com/jmiguelrivas/tambora/actions"><img alt="Build Status" src="https://github.com/jmiguelrivas/tambora/actions/workflows/android.yml/badge.svg?branch=master"></a>
</p>
...
Tambora encourages **mindful device usage**, helping you reduce distractions and monitor your
hardware
health.
...
Download the latest APK from the **[Releases page](https://github.com/jmiguelrivas/tambora/releases)
**
...
**Tambora Launcher** is Free Software. You are free to use, study, share, and improve it under the
